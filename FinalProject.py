...
# average height  that all the skyscrapers achieved until 2000 not just in 2000
...
def main():
    ...
    tt = pd.pivot_table(skyscrapers_data, index=['CITY', 'COMPLETION', 'MATERIAL'], values=['Meters'])
    st.dataframe(tt)
